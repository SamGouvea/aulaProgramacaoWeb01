...
document.addEventListener("DOMContentLoaded", () => {
      ...
      link.addEventListener("click", async (e) => {
        ...
        try {
          ...
          if (newMain) {
            ...
            window.scrollTo(0, 0);
            reinitializeScripts(); // Reativa funcionalidades
          }
        } catch (err) {
    ...
    window.addEventListener("popstate", async () => {
      ...
      try {
        ...
        main.innerHTML = "<p>Erro ao restaurar conteúdo.</p>";
      }
    });
  
    reinitializeScripts(); // Inicializa na primeira carga
  });
  
  // ==================== Reativa scripts após troca SPA ====================
